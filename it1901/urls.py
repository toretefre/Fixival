...
urlpatterns = [
    ...
    url(r'^bookingsjef/$',views.bookingsjef_velkommen,name="bookingsjef_velkommen"),
    url(r'^bookingsjef/prisgenerator/$',views.bookingsjef_prisgenerator,name="webapp/bookingsjef_prisgenerator"),
    ...
    url(r'^pr_ansvarlig/konsert', views.pr_ansvarlig_konserter, name="webapp/pr_ansvarlig_konserter"),
]
